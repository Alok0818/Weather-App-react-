...
const Weather = () => {
  ...
  let weatherAPI = {
    key: "87d505100f21704c9729eccf599d92dd",
  ...
  }, [data.coord?.lat, data.coord?.lon, weatherAPI.key]);
  ...
  }, [query, weatherAPI.baseUrl, weatherAPI.key]);
  ...
  const inPutBox = () => {
    ...
    {
      !query ? filterData("") : filterData(query);
    }
    setDisplayMode(true);
  };
  ...
  return (
    <main>
      ...
      {location.loaded && data.sys?.country === "IN" && cordData.daily && (
        <>
          {/* Daily Forcast Box*/}
